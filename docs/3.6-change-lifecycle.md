...
neither of us gave at the time: `merge` names **one of the two** delivery
moments, and under the standing pre-approval most process changes are edited
straight on `main`, so they are delivered on save and never merged at all.
