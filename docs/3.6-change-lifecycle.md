...
**The only work that carries no milestone is a pre-approved requirement that
never becomes a project** (owner, 2026-09-04) — a documentation or tooling edit
made straight on `main`. Everything that reaches a project reaches the log.
