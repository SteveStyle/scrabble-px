...
| **`Decision State`** | `Asked · Decided · Actioned`, the columns of the Decisions board |
...
**`Actioned` and closed coincide** (owner, 2026-09-05), and closed means
**applied**: an agreed decision with every action ticked. Not merely answered.
