...
no sub-issue: delivery 1 stays a row. A rehearsal deploy changes the image and
still ships nothing, which is why the test is *did a release carry it*, not
*did it change the image*.
