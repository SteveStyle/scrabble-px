...
**It is on Requirement, Project and Project Delivery**, so the answer can be given
at whatever level the work is being discussed. They are independent: a project can
be `Not Pre-approved` while one of its deliveries — a documentation update, say —
is approved to go straight to `main`.
