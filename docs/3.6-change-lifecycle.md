...
*delivery* has a milestone, not that every project has a delivery. A project
whose work is a stream of small pre-approved changes — #299, the document
rewrite, is the worked example at 52 commits — records nothing in the log.
Owner, 2026-09-04: *"I don't think we need a milestone or a delivery log entry.
We have the closed project for the history, and the commits."*
