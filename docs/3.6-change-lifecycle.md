...
five headings kept current, and a stale one is worse than none. Overwriting the
...
| **projects** | *a thing* | where work happens. The **Project** form: five headings, kept current |
