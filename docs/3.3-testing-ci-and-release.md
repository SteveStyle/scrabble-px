...
change](3.5-change-lifecycle.md#215-classifying-a-change-type-release-route):
...
[How a change reaches production](3.5-change-lifecycle.md#1-the-flow-how-a-change-reaches-production) below.
...
**Moved to [3.5 The change lifecycle](3.5-change-lifecycle.md)** on 2026-08-21 —
...
**Moved to [3.5 The change lifecycle](3.5-change-lifecycle.md#3-notes-on-releases-and-branches)**,
