...
The second is easy to miss, because a merge-lane change is small by
definition — but small is not the same as quick, and it is the time in
progress that blocks other people, not the size of the diff.
