...
| Rehearsal | Is the [rehearsal host](#22-the-four-environments) running that same commit? | Read from its `/health`. Catches the easy-to-miss case: rehearse commit A, commit a "quick fix" B, deploy — without this, B ships having been rehearsed nowhere |
