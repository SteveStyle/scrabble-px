...
Plain `http://` requests get redirected to `https://` automatically — no separate config for that either. (Preview skips all of this — see [Testing, CI & Release](3.3-testing-ci-and-release.md#preview-environment).)
